...
env TRIAL=1 target/release/checksuminator binary --init "$TARGET_DIR/.theos/_/Library/MobileSubstrate/DynamicLibraries/Zinnia.dylib" -s res/strings/main.plist -s res/strings/drm.production.plist  || exit 1
...
env TRIAL=1  target/release/checksuminator binary "$TARGET_DIR/.theos/_/Library/PreferenceBundles/ZinniaPrefs.bundle/ZinniaPrefs" -s res/strings/main.plist -s res/strings/drm.production.plist || exit 1
