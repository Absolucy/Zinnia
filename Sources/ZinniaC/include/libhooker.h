 ...
 * @constant LIBHOOKER_ERR_BAD_INSN_AT_START A problematic instruction was found at the start. We can't preserve the
 * original function due to this instruction getting clobbered.
