 ...
 * original method. This also provides a guarantee that hooking a class that doesn't implement a method won't overwrite
 ...
 */
extern enum LIBHOOKER_ERR LBHookMessage(Class objcClass, SEL selector, void* replacement, void* old_ptr)
